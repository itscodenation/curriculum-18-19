...
| [**6: Variables, Value Types, Operators, input.val**](units/unit6) | 3 lessons <br> 1 project  |<ul> <li> Create a new variable, store information in it, and read its value. </li><li> Identify strings and numbers as value types and differentiate between them. </li><li>Use operators to manipulate variables.</li><li> Use input.val( ) to retrieve a value from an input field. </li><li> Use variables and operators to create a website that predicts the future. </li> </ul>|
...
| [**9: Functions**](units/unit9) |3 lessons <br> 1 project  | <ul> <li> Use functions to break long sections of code into smaller, easier to understand pieces.</li><li> Write function declarations to improve code organization.</li><li> Use functions to reduce duplications in code.</li><li>Use functions to create a Mood Board web app that updates based on user input.	</l1></ul>|
| [**End-of-Year Wrap Up**](units/EOY_Review_Unit) | 2 lessons |<ul> <li> Complete an end-of-year survey to reflect on their Code Nation experience and share feedback. </li><li> Celebrate their technical mastery and showcase exemplar projects. </li></ul>|
